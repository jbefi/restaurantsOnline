...
class Finestra extends JFrame {
	...
	public Finestra(String titol, LlistaProducte llistaProducte, LlistaComanda llistaComandes,
		...
		JLabel etiqueta2 = new JLabel("Tri√Ø una opci√≥ del men√∫ desplegable :");
		// Desplegable ('ComboBox') per mostrar totes les opcions del men√∫
		String[] opcionsMenu = { "Afegir nou producte", "Eliminar producte", "Informaci√≥ d'un producte", "Crear client","Consultar Client",
		...
		desplegable.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				...
				case 1:
					...
					break;
				case 2:
					// Informaci√≥ d'un producte
					new Fines_InfoProducte("Informaci√≥ d'un producte", llistaProducte);
					break;
				case 3:
					// Crear client
					...
					break;
				case 4:
					new Fines_consultarClient("Informaci√≥ d'un client", llistaClients);
...
// Classe per crear la finestra que serveix per consultar tota la informaci√≥ d'un producte de la llista.
	...
	public Fines_InfoProducte(String titol, LlistaProducte llistProds) {
		...
		boto.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				textArea.append(llistProds.informacio(codi)); // Mostro la informaci√≥
			}
		});
...
//CLASSE PRINCIPAL 
		 ...
		 afegirComanda(String titol, LlistaProducte llistaProducte, LlistaComanda llistaComandes,
			LlistaClients llistaClients){
			 super(titol); 
				...
				// PANEL 2
				JPanel panel2 = new JPanel(new GridBagLayout());
				JLabel etiqueta2 = new JLabel("Tri√Ø una opci√≥ per a veure la nostra disponibilitat de productes i escollir-los :"); 
	...
	class Plats extends JFrame{
		...
		Plats (String titol, LlistaProducte llistaProducte) {
			...
			JButton seguent = new JButton ( "Seg√ºent"); 
...
class Fines_CreaClient extends JFrame {
	...
	public Fines_CreaClient(String titol, LlistaClients llistacl) {
		super(titol);
		// Contenidor de la finestra principal, contÈ 2 panels horitzontals
		Container contenidor = getContentPane();
		contenidor.setLayout(new BorderLayout(10, 10));
...
class Fines_Registrat extends JFrame {
	...
	public Fines_Registrat(Clients client) {
		// Contenidor de la fiestra principal, contÈ 2 panels horitzontals
		Container contenidor = getContentPane();
		contenidor.setLayout(new BorderLayout(10, 10));
		...
		textArea.append("L'usuari: "+client.getUsuari()+ " s'ha registrat amb exit"); // Mostro la informaciÛ
	...
	public Fines_LlistarComandes(String titol, LlistaClients llistacl) {
		...
		boto.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae) {
				...
				textArea.append("L'usuari o contrasenya son incorrectes"); // Mostro la informaciÛ
				}
			}
		});
...
class Fines_MostrarComandes extends JFrame {
	...
	public Fines_MostrarComandes(LlistaComanda llistacom) {
		...
		textArea.append(llistacom.toString()); // Mostro la informaciÛ
